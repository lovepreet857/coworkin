              ...
              >
{
    Featureddata.map((iteam,index)=>(
        <SwiperSlide key={index} className="rounded-3xl overflow-hidden bg-Flash-White max-w-[335px] w-full sm:max-w-[419px] max-h-[528px]">
          <img src={iteam.mainimg} alt="mainimg" />
          <h1 className="px-[20px] pt-6 text-black-black font-medium font-Inter text-[20px] sm:text-[22px] leading-[130%]">{iteam.titel}</h1>
          <div className="px-[20px] pt-3 pb-[30px] flex flex-col gap-[21px]">
            <div className="flex gap-[10px]">
              <img src={iteam.locationsvg} alt="" />
              <p className="text-dark-grya text-base font-normal font-Inter leading-[130%]">{iteam.locationname}</p>
            </div>
            ...
            <div className="flex justify-between items-center">
              <div className="flex gap-[10px]">
                ...
                <p className="text-dark-grya leading-[130%] text-base font-Inter font-normal">{iteam.reviews}</p>
              </div>
